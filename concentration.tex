...
\begin{tikzpicture}
    ...
    \draw node at (-7,0.8563) {$\hat{y}(p,p^\prime)$};
...
Next we consider the number of common neighbors between two nodes $p$ and $p^\prime$ in $\Gbox$, which we denote by $\Ncal_{\Pcal}(p,p^\prime)$. 
...
We first establish an almost independence result for integrals over the joint degree distribution $\rho_{\text{box}}(p,p^\prime,k,k^\prime)$ for the case where  $p$ and $p^\prime$ are sufficiently separated. For this we note that when $|x - x^\prime| \gg e^{y/2} + e^{y^\prime/2}$ it follows from Lemma~\ref{lem:disjoint_neighbors_P_n_large}
\[
...
%Define $\delta_n = k_n^{-\frac{(1-\varepsilon)\varepsilon}{2}}$. Then, since $\Exp{X_3(p,p^\prime)} = \Exp{\Ncal_{\text{box}}(p,p^\prime)} \ge k_n^{\varepsilon}$ for all $(p,p^\prime) \in \mathcal{E}_\varepsilon(k_n)$, a Chernoff bound (c.f. \eqref{eq:def_chernoff_bound_poisson}) implies that
%\[
%	\Prob{|X_3(p,p^\prime) - \Exp{X_i(p,p^\prime)}| > \delta_n \Exp{X_3(p,p^\prime)}} = \bigO{e^{-k_n^{\varepsilon}}},
%\]
%uniformly on $\mathcal{E}_\varepsilon(k_n)$. It now follows that
%\begin{align*}
...
%\end{align*}
%and similar for the sum over all $t < (1 - \delta_n) \Exp{X_3(p,p^\prime)}$. Hence if we define
%\[
%	A_n(p,p^\prime) = \left\{t : (1 - \delta_n) \Exp{X_3(p,p^\prime)} \le t \le (1+\delta_n)\Exp{X_3(p,p^\prime)}\right\},
%\] 
%then
%\begin{align*}
%	&\hspace{-20pt}\rho_{\text{box}}(p,p^\prime,k_n,k_n) \\
...
%\[
%	\rho_{\text{box}}(p,p^\prime,k_n,k_n) = (1 + \smallO{1})\Prob{X_1(p,p^\prime) = k_n - t_n}
...
%\begin{align*}
%	&\int_{\mathcal{E}_{\varepsilon}(k_n)} \rho_{\text{box}}(p,p^\prime,k_n,k_n) h(y) h(y^\prime) f(x,y)
...
%\begin{align*}
%	\rho_{\text{box}}(p,p^\prime,k_n,k_n) &= \Prob{X_1(p,p^\prime) + X_3(p,p^\prime) = k_n, X_2(p,p^\prime) + X_3(p,p^\prime) = k_n}\\
...
%
%Take $a_n = 2\log\left((k_n + C\log(n))/\xi\right)$ and let $I_{a,b}^\ast$ denote the the part of $I_{a,b}$ where $(p,p^\prime) \in \mathcal{E}(k_n)$ as defined in~\eqref{eq:def_joint_degree_set_E_constant_k}. We will show that the expected difference between $I_{a,b}$ and $I_{a,b}^\ast$ is of smaller order than $\Exp{T_\Pcal(k_n)}^2$ so that we only need to consider $I_{a,b}^\ast$. 
%
%Since 
%\[
...
%	&\le \int_{\mathcal{E}_{C}(k_n)^c} \rho_{\text{box}}(y,k_n) \Exp{J_b(p,p^\prime)}
%		f(x,y) f_{\alpha, \nu}(x^\prime, y^\prime) \dd x^\prime \dd x \dd y^\prime \dd y\\
%	&\le \int_{\mathcal{E}_{C}(k_n)^c} \rho_{\text{box}}(y,k_n) \Exp{\widetilde{T}_{\text{box}}(p)}
%		\Exp{\widetilde{T}_{\text{box}}(p^\prime)} 
%		f(x,y) f_{\alpha, \nu}(x^\prime, y^\prime) \dd x^\prime \dd x \dd y^\prime \dd y\\
%	&\le \bigO{\log(n)^2} \left(\int_{\Kcal_{C}(k_n)} \rho_{\text{box}}(y,k_n) \Exp{\widetilde{T}_{\text{box}}(p)} 
...
%\[
%	\mathcal{J}_1^\ast = \int_{\Rcal^2} \ind{0\le y_1, y_2 \le h(p,p^\prime)} \widetilde{T}_{\text{box}}(p,p_1,p_2) 
...
%\[
%	\mathcal{J}_1^\ast = (1+\smallO{1})\Exp{\widetilde{T}_{\text{box}}(p)} = (1 + \smallO{1})\binom{k_n}{2} \Delta_\Pcal(y),
%\] 
%and similar for $\mathcal{J}_2^\ast$, while Lemma~\ref{lem:joint_degree_factorization} states that
%\begin{align*}
%	&\hspace{-30pt}\int_{\mathcal{E}(k_n)} \rho_{\text{box}}(p,p^\prime,k_n,k_n) \Delta_\Pcal(y) \Delta_\Pcal(y^\prime)
%		f(x,y) f_{\alpha, \nu}(x^\prime, y^\prime) \dd x^\prime \dd x \dd y^\prime \dd y\\
...
%\begin{align*}
%	\Exp{I_{0,0}^\ast} 
%	&= \int_{\mathcal{E}(k_n)} \rho_{\text{box}}(p,p^\prime,k_n,k_n) \Exp{J_0(p,p^\prime)}
%		f(x,y) f_{\alpha, \nu}(x^\prime, y^\prime) \dd x^\prime \dd x \dd y^\prime \dd y \\
%	&= \int_{\mathcal{E}(k_n)} \rho_{\text{box}}(p,p^\prime,k_n,k_n) \Delta_\Pcal(y) \Delta_\Pcal(y^\prime)
%		f(x,y) f_{\alpha, \nu}(x^\prime, y^\prime) \dd x^\prime \dd x \dd y^\prime \dd y\\
