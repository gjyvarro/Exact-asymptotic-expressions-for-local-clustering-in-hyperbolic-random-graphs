...
\MS{Some ideas:
\begin{enumerate}
\item Hyperbolic random graphs as an alternative to Euclidean/standard random geometric graphs
\end{enumerate}
}

\PvdH{Add intro on common features of complex networks and modeling of such networks.}
