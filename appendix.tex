...
\section{Explicit expressions for \texorpdfstring{$\gamma, \gamma(k)$}{gamma, gamma(k)} when \texorpdfstring{$\alpha=1$}{alpha equals 1}.}\label{ssec:alphais1}
