...
\usepackage{pgfplots}https://www.overleaf.com/project/5bc61276e8425335eb304779
...
\DeclareMathOperator{\dd}{\, \mathrm{d}\hspace{-1pt}}			%	straight d for integration
...
\newcommand{\expH}{\overline{n}_{\H}(k_n)}
...
\PvdH{Below is a list of high and low level to do items. Please add comments using the commands below.

\noindent Comment commands:\\
Markus: \textbackslash MS\\
Nikolaos: \textbackslash NF\\
Pim: \textbackslash PvdH\\
Tobias: \textbackslash TM

}

\ToDo{High level list:

\begin{itemize}
\item Streamline notations and writing of some sections
\item Finish introduction
\item Complete bibliography list
\item Add additional explanation for the Hyperbolic model.
\item Add additional observations based on our main result
\end{itemize}
}
