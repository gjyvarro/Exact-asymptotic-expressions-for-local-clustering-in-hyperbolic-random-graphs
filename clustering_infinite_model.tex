...
\end{tikzpicture}
\caption{Situation for the intersections of the connection intervals considered in Lemma~\ref{lem:ordered}, with $y_0 < y_1 <y_2$ and $0 \le x_1 \le e^{(y_0 + y_1)/2}$. The regime for $x_2$ in which case a triangle is formed is colored in red on both intervals. \PvdH{Maybe show the full connection balls.}}
