...
taking the $\alpha\to 1$ limit of the expression obtained for $\alpha=1$. Here we derive an alternative explicit expression for completeness. This is what we will do in the current section.
